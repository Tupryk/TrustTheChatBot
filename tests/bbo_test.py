...
from TrustTheChatBot.tasks.const_functions import beer_cost_func
...
if __name__ == "__main__":
    ...
    optimal_code = compute_optimal_floats_on_code(beer_cost_func, clean_text, C, verbose=2, bbo_options=bbo_options)
    print(optimal_code)
